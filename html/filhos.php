<?php $nomeProjeto = "Árvore filhos";
require_once("header.php");

?>
<div class="col-12">
	<div class="card mt-4">
	  <h5 class="card-header"> Árvore(filhos) - ligados apenas em um nível</h5>
	  <div class="card-body">
				...
				<table id="tabelaPrincipal" class="table table-striped">
					<thead>
						<tr>
							...
							<th style="text-align: center;"> Valor(Filhos direto) </th>
	        ...
	        $.each(json.data.dados, function (key, item) {
		        ...
		        */
				ConteunoNovo += '<tr>';
					...
					ConteunoNovo += '</td>';
					ConteunoNovo += '<td style="text-align: center;">';
						ConteunoNovo += (item.filhos_valor * 1).toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
					ConteunoNovo += '</td>';
					ConteunoNovo += '<td style="text-align: center;">';
						ConteunoNovo += ((item.node_value * 1 + item.filhos_valor * 1)).toLocaleString('pt-br',{style: 'currency', currency: 'BRL'});
					ConteunoNovo += '</td>';
				ConteunoNovo += '</tr>';
	        })
